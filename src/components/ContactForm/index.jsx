      ...
      <div className='contact-info'>
        ...
        <div className='contact-social'>
          <div className='contact-social__item'>
            <img src='../images/icons/social/web-md.svg' alt='' className='contact-social__icon' />
          ...
          <div className='contact-social__item'>
            <img src='../images/icons/social/vk-md.svg' alt='' className='contact-social__icon' />
            <p className='contact-social__title'>
              Вконтакте:{' '}
          ...
          <div className='contact-social__item'>
            <img src='../images/icons/social/telegram-md.svg' alt='' className='contact-social__icon' />
            <p className='contact-social__title'>
              Telegram:{' '}
